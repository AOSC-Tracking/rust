...
mod mips {
    ...
    pub mod mips {
        ...
        pub const ffi_abi_FFI_CLOSURES: u32 = 1;
        pub const ffi_abi_FFI_GO_CLOSURES: u32 = 1;
        pub const ffi_abi_FFI_NATIVE_RAW_ABI: u32 = 0;

        pub const ffi_abi_FFI_TRAMPOLINE_SIZE: usize = 20;
    }
    ...
    pub mod mips64 {
        ...
        pub const ffi_abi_FFI_TRAMPOLINE_SIZE: usize = 56;
    }
}
